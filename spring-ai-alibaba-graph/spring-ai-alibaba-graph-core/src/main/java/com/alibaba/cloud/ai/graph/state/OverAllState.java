...
public class OverAllState {
     ...
     * @return the optional
     */
    public Optional<Map<String, Object>> nodeState(String nodeId) {
        return Optional.of((Map<String, Object>) this.data.get(nodeId));
    }
     ...
     * @return the optional
     */
    public Optional<Object> nodeState(String nodeId, String key) {
        return Optional.of(((Map<String, Object>) this.data.get(nodeId)).get(key));
    }
